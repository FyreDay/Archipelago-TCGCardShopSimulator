...
def set_rules(world, ignore_item_name):
    ...
    world.multiworld.register_indirect_condition("Shop B Expansion 1", "Level 20-24")
    world.multiworld.register_indirect_condition("Shop B Expansion 2", "Level 25-29")
    world.multiworld.register_indirect_condition("Shop B Expansion 3", "Level 30-34")
    world.multiworld.register_indirect_condition("Shop B Expansion 4", "Level 35-39")
    world.multiworld.register_indirect_condition("Shop B Expansion 5", "Level 50-54")
    world.multiworld.register_indirect_condition("Shop B Expansion 6", "Level 55-59")
    world.multiworld.register_indirect_condition("Shop B Expansion 7", "Level 60-64")
    world.multiworld.register_indirect_condition("Shop B Expansion 8", "Level 65-69")
    world.multiworld.register_indirect_condition("Shop B Expansion 9", "Level 80-84")
    world.multiworld.register_indirect_condition("Shop B Expansion 10", "Level 85-89")
    world.multiworld.register_indirect_condition("Shop B Expansion 11", "Level 90-94")
    world.multiworld.register_indirect_condition("Shop B Expansion 12", "Level 95-99")
    world.multiworld.register_indirect_condition("Shop B Expansion 13", "Level 110-115")
    world.multiworld.register_indirect_condition("Shop B Expansion 14", "Level 110-115")
