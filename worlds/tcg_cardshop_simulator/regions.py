...
def connect_entrances(world):
    ...
    connect_regions(world, "Level 10-14", "Epic Card Pack", "Epic Card Pack")
    connect_regions(world, "Level 10-14", "Level 15-19", "Level 15")
    connect_regions(world, "Level 15-19", "Level 20-24", "Level 20")
    connect_regions(world, "Level 20-24", "Legendary Card Pack", "Legendary Card Pack")
    connect_regions(world, "Level 20-24", "Level 25-29", "Level 25")
    connect_regions(world, "Level 25-29", "Destiny Common Card Pack", "Destiny Common Card Pack")
    connect_regions(world, "Level 25-29", "Level 30-34", "Level 30")
    connect_regions(world, "Level 30-34", "Destiny Rare Card Pack", "Destiny Rare Card Pack")
    connect_regions(world, "Level 30-34", "Level 35-39", "Level 35")
    connect_regions(world, "Level 35-39", "Level 40-44", "Level 40")
    connect_regions(world, "Level 40-44", "Destiny Epic Card Pack", "Destiny Epic Card Pack")
    connect_regions(world, "Level 40-44", "Level 45-49", "Level 45")
    connect_regions(world, "Level 45-49", "Level 50-54", "Level 50")
    connect_regions(world, "Level 50-54", "Destiny Legendary Card Pack", "Destiny Legendary Card Pack")
