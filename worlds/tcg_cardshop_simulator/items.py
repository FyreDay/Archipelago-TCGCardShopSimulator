...
def create_items(world):
    ...
    print(f"location count: {total_location_count}")
    ...
    print(f"item count: {len(world.itempool)}")
...
item_dict: Dict[str, ItemData] = {
    "Fire Battle Deck (18)": ItemData(0x1F280005, ItemClassification.filler),
    "Earth Battle Deck (18)": ItemData(0x1F280006, ItemClassification.filler),
    "Water Battle Deck (18)": ItemData(0x1F280007, ItemClassification.filler),
    "Wind Battle Deck (18)": ItemData(0x1F280008, ItemClassification.filler),
    "Fire Destiny Deck (18)": ItemData(0x1F28000D, ItemClassification.filler),
    "Earth Destiny Deck (18)": ItemData(0x1F28000E, ItemClassification.filler),
    "Water Destiny Deck (18)": ItemData(0x1F28000F, ItemClassification.filler),
    "Wind Destiny Deck (18)": ItemData(0x1F280010, ItemClassification.filler),
    "Card Sleeves (Clear)": ItemData(0x1F280012, ItemClassification.filler),
    "Card Sleeves (Tetramon)": ItemData(0x1F280013, ItemClassification.filler),
    "D20 Dice Red (16)": ItemData(0x1F280014, ItemClassification.filler),
    "D20 Dice Blue (16)": ItemData(0x1F280015, ItemClassification.filler),
    "D20 Dice Black (16)": ItemData(0x1F280016, ItemClassification.filler),
    "D20 Dice White (16)": ItemData(0x1F280017, ItemClassification.filler),
    "Card Sleeves (Fire)": ItemData(0x1F280018, ItemClassification.filler),
    "Card Sleeves (Earth)": ItemData(0x1F280019, ItemClassification.filler),
    "Card Sleeves (Water)": ItemData(0x1F28001A, ItemClassification.filler),
    "Card Sleeves (Wind)": ItemData(0x1F28001B, ItemClassification.filler),
    "Collection Book (4)": ItemData(0x1F280020, ItemClassification.filler),
    "Premium Collection Book (4)": ItemData(0x1F280021, ItemClassification.filler),
    "Playmat (Drilceros)": ItemData(0x1F280022, ItemClassification.filler),
    "Playmat (Clamigo)": ItemData(0x1F280023, ItemClassification.filler),
    "Playmat (Wispo)": ItemData(0x1F280024, ItemClassification.filler),
    "Playmat (Lunight)": ItemData(0x1F280025, ItemClassification.filler),
    "Playmat (Kyrone)": ItemData(0x1F280026, ItemClassification.filler),
    "Playmat (Duel)": ItemData(0x1F280027, ItemClassification.filler),
    "Playmat (Dracunix1)": ItemData(0x1F280028, ItemClassification.filler),
    "Playmat (The Four Dragons)": ItemData(0x1F280029, ItemClassification.filler),
    "Playmat (Drakon)": ItemData(0x1F28002A, ItemClassification.filler),
    "Playmat (GigatronX Evo)": ItemData(0x1F28002B, ItemClassification.filler),
    "Playmat (Fire)": ItemData(0x1F28002C, ItemClassification.filler),
    "Playmat (Earth)": ItemData(0x1F28002D, ItemClassification.filler),
    "Playmat (Water)": ItemData(0x1F28002E, ItemClassification.filler),
    "Playmat (Wind)": ItemData(0x1F28002F, ItemClassification.filler),
    "Playmat (Tetramon)": ItemData(0x1F280030, ItemClassification.filler),
    "Pigni Plushie (12)": ItemData(0x1F280031, ItemClassification.filler),
    "Nanomite Plushie (16)": ItemData(0x1F280032, ItemClassification.filler),
    "Minstar Plushie (24)": ItemData(0x1F280033, ItemClassification.filler),
    "Nocti Plushie (6)": ItemData(0x1F280034, ItemClassification.filler),
    "Burpig Figurine (12)": ItemData(0x1F280035, ItemClassification.filler),
    "Decimite Figurine (8)": ItemData(0x1F280036, ItemClassification.filler),
    "Trickstar Figurine (12)": ItemData(0x1F280037, ItemClassification.filler),
    "Lunight Figurine (8)": ItemData(0x1F280038, ItemClassification.filler),
    "Inferhog Figurine (2)": ItemData(0x1F280039, ItemClassification.filler),
    "Meganite Figurine (2)": ItemData(0x1F28003A, ItemClassification.filler),
    "Princestar Figurine (2)": ItemData(0x1F28003B, ItemClassification.filler),
    "Vampicant Figurine (2)": ItemData(0x1F28003C, ItemClassification.filler),
    "Blazoar Plushie (2)": ItemData(0x1F28003D, ItemClassification.filler),
    "Giganite Statue (2)": ItemData(0x1F28003E, ItemClassification.filler),
    "Kingstar Plushie (2)": ItemData(0x1F28003F, ItemClassification.filler),
    "Dracunix Figurine (1)": ItemData(0x1F280040, ItemClassification.filler),
    "Bonfiox Plushie (8)": ItemData(0x1F280041, ItemClassification.filler),
    "Drilceros Action Figure (4)": ItemData(0x1F280042, ItemClassification.filler),
    "ToonZ Plushie (6)": ItemData(0x1F280043, ItemClassification.filler),
    ...
    "System Gate #1": ItemData(0x1F280052, ItemClassification.filler),
    "System Gate #2": ItemData(0x1F280053, ItemClassification.filler),
    "Mafia Works": ItemData(0x1F280054, ItemClassification.filler),
    "Necromonsters": ItemData(0x1F280055, ItemClassification.filler),
    "Claim!": ItemData(0x1F280056, ItemClassification.filler),
    "Penny Sleeves": ItemData(0x1F280057, ItemClassification.filler),
    "Tower Deckbox": ItemData(0x1F280058, ItemClassification.filler),
    "Magnetic Holder": ItemData(0x1F280059, ItemClassification.filler),
    "Toploader": ItemData(0x1F28005A, ItemClassification.filler),
    "Card Preserver": ItemData(0x1F28005B, ItemClassification.filler),
    "Playmat Gray": ItemData(0x1F28005C, ItemClassification.filler),
    "Playmat Green": ItemData(0x1F28005D, ItemClassification.filler),
    "Playmat Purple": ItemData(0x1F28005E, ItemClassification.filler),
    "Playmat Yellow": ItemData(0x1F28005F, ItemClassification.filler),
    "Pocket Pages": ItemData(0x1F280060, ItemClassification.filler),
    "Card Holder": ItemData(0x1F280061, ItemClassification.filler),
    "Collectors Album": ItemData(0x1F2800B5, ItemClassification.filler),
    ...
    "Playmat (Dracunix2)": ItemData(0x1F2800BE, ItemClassification.filler),
    "Playmat (GigatronX)": ItemData(0x1F2800BF, ItemClassification.filler),
    "Playmat (Katengu Black)": ItemData(0x1F2800C2, ItemClassification.filler),
    "Playmat (Katengu White)": ItemData(0x1F2800C3, ItemClassification.filler),
    "Manga 1": ItemData(0x1F2800C4, ItemClassification.filler),
    "Manga 2": ItemData(0x1F2800C5, ItemClassification.filler),
    "Manga 3": ItemData(0x1F2800C6, ItemClassification.filler),
    "Manga 4": ItemData(0x1F2800C7, ItemClassification.filler),
    "Manga 5": ItemData(0x1F2800C8, ItemClassification.filler),
    "Manga 6": ItemData(0x1F2800C9, ItemClassification.filler),
    "Manga 7": ItemData(0x1F2800CA, ItemClassification.filler),
    "Manga 8": ItemData(0x1F2800CB, ItemClassification.filler),
    "Manga 9": ItemData(0x1F2800CC, ItemClassification.filler),
    "Manga 10": ItemData(0x1F2800CD, ItemClassification.filler),
    "Manga 11": ItemData(0x1F2800CE, ItemClassification.filler),
    "Manga 12": ItemData(0x1F2800CF, ItemClassification.filler),
    ...
    "Cleanser (64)": ItemData(0x1F2800F0, ItemClassification.progression),
    "Deck Box Red (8)": ItemData(0x1F28001C, ItemClassification.filler),
    "Deck Box Red (16)": ItemData(0x1F2800F1, ItemClassification.filler),
    "Deck Box Green (8)": ItemData(0x1F28001D, ItemClassification.filler),
    "Deck Box Green (16)": ItemData(0x1F2800F2, ItemClassification.filler),
    "Deck Box Blue (8)": ItemData(0x1F28001E, ItemClassification.filler),
    "Deck Box Blue (16)": ItemData(0x1F2800F3, ItemClassification.filler),
    "Deck Box Yellow (8)": ItemData(0x1F28001F, ItemClassification.filler),
    "Deck Box Yellow (16)": ItemData(0x1F2800F4, ItemClassification.filler),
}
